...
public class VoidBoots extends ArmorItem {
    public VoidBoots() {
        super("Boots Of the Void Lord", "void_boots", Rarity.EPIC, Type.BOOTS, Material.LEATHER_BOOTS, Map.of(Stats.STRENGTH, 2d, Stats.HEALTH, 5d, Stats.WISDOM, 50d, Stats.REGENERATION, 5d));
