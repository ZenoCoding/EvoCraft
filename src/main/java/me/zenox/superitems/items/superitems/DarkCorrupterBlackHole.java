...
public class DarkCorrupterBlackHole extends ComplexItem {
    public DarkCorrupterBlackHole() {
        super(ChatColor.DARK_PURPLE + "Dark Corrupter Gravity", "dark_corrupter_gravity", Rarity.EPIC, Type.STAFF, Material.BLACK_CANDLE, Map.of(), List.of(new Corruption(10, true, Double.MAX_VALUE)));
