...
import static me.zenox.superitems.items.ItemRegistry.ENCHANTED_OBSIDIAN;

public class CompactObsidian extends ComplexItem implements Listener {

    public CompactObsidian() {
        super("Compact Obsidian", "compact_obsidian", Rarity.UNCOMMON, Type.MISC, Material.PLAYER_HEAD, Map.of());
    ...
    public List<Recipe> getRecipes() {
        ...
        recipe.setIngredient('O', new RecipeChoice.ExactChoice(ENCHANTED_OBSIDIAN.getItemStack(1)));
