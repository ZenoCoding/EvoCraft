...
import me.zenox.superitems.item.abilities.ObsidilithScytheAbility;
...
public class ObsidianScythe extends ComplexItem {
    public ObsidianScythe() {
        super("obsidian_scythe", Rarity.LEGENDARY, Type.MISC, Material.NETHERITE_HOE, Map.of(), List.of(new ObsidilithScytheAbility()));
