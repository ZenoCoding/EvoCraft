...
public class DamagedByEntityEnchantment extends ComplexEnchantment{
    ...
    public DamagedByEntityEnchantment(String id, int maxLevel, int rarity, List<ComplexItem.Type> types, Slot slot, List<StatModifier> stats, QuadConsumer<Event, Integer, ItemStack, Player> executable) {
