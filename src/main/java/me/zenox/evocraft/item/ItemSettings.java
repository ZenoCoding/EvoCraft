...
public class ItemSettings {
    ...
    public List<me.zenox.evocraft.attribute.AttributeModifier> getAttributeModifiers() {
    ...
    public ItemSettings modifier(me.zenox.evocraft.attribute.AttributeModifier ... modifiers){
        this.attributeModifiers.addAll(List.of(modifiers));
        return this;
    }

    public ItemSettings setAttributeModifiers(List<me.zenox.evocraft.attribute.AttributeModifier> attributeModifiers) {
        this.attributeModifiers = attributeModifiers;
        return this;
    }
}
